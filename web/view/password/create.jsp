<%-- 
    Document   : create
    Created on : Jul 12, 2016, 6:29:15 PM
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2> <small>Create Password Policy </small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div style="display: block;" class="x_content">
                        <form data-parsley-validate class="form-horizontal form-label-left" novalidate="" action="${pageContext.request.contextPath}/pass/create" method="post">
                            ...
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12   xdisplay_inputx  has-feedback">
                                    <input  id="single_cal3"  aria-describedby="inputSuccess2Status3"class="form-control has-feedback-left col-md-7 col-xs-12 " data-validate-length-range="6" data-validate-words="2" name="startDate"  data-parsley-required="true" type="text"    >
                            ...
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12   xdisplay_inputx  has-feedback">
                                    <input  id="single_cal4"  aria-describedby="inputSuccess2Status3" class="form-control has-feedback-left col-md-7 col-xs-12 " data-validate-length-range="6" data-validate-words="2" name="endDate"  data-parsley-required="true" type="text" >
                                    <span  class="fa fa-calendar form-control-feedback left" ></span>
                                </div>
