            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div style="display: block;" class="x_content">
                        ...
                        <form data-parsley-validate class="form-horizontal form-label-left" novalidate="" action="${pageContext.request.contextPath}/cmpo/user/create" method="POST">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select name="cmpoId" id="selectOperator" class="form-control">
                                        <c:forEach items="<%=cmpoModelManager.listAll(userSession.getUserCmpoId())%>" var="cmpoModel" varStatus="counter">
                                            <option value="${cmpoModel.getCmpoSeq()}">${cmpoModel.getCmpoName()}</option>
                                        </c:forEach> 
                                    </select>
                            ...
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="userName" class="form-control col-md-7 col-xs-12"  name="userName" placeholder="" data-parsley-required="true" type="text">
                                </div>
                            </div>
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="userId" class="form-control col-md-7 col-xs-12" name="userId" placeholder="letters, numbers, @, _ " data-parsley-pattern="/^[a-zA-Z0-9@_]+$/"  data-parsley-required="true" type="text">
                                </div>
                            </div>
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="password" class="form-control col-md-7 col-xs-12" name="password" placeholder="" data-parsley-required="true" type="password">
                                </div>
                            </div>
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input data-parsley-equalto="#password" id="retypePassword" class="form-control col-md-7 col-xs-12"  name="retypePassword" placeholder="" data-parsley-required="true" type="password">
                                </div>
                            </div>               
                            ...
                            <div class="item form-group bad">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="checkbox" id="isAdmin">
                                        <label >
                                            <input name="isAdmin" type="checkbox"> System Admin (account can not be locked)
                                        </label>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-bordered" >
                                            ...
                                            <c:forEach items="<%=cmpoRoleModelManager.listAll(userSession.getUserCmpoId())%>" var="cmpoRoleModel" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="v${cmpoRoleModel.getId()}" id="v${cmpoRoleModel.getId()}" ${aclModel.isAllowed() ? 'checked' : ''} type="checkbox" > 
                                                    </td>
                                                </tr>
                                            </c:forEach>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/cmpo/user">Cancel</a>
