    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Sim Verification Consent Unconsent Report  </h3>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div style="display: block;" class="x_content">
                        <form data-parsley-validate class="form-horizontal form-label-left" novalidate="" action="${pageContext.request.contextPath}/report/sv" method="post">

                            <!--  cmpo dropdown --->
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-3 form-group has-feedback">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12 " style="text-align: left">Operator</label>
