 ...
 * @author rahat
 */
@WebServlet(name = "ViewBlackList", urlPatterns = {"/blackList/view"})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ViewBlackListServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ViewBlackListServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
