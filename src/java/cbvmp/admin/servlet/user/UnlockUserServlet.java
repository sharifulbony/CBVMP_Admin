...
@WebServlet(name = "UnlockUser", urlPatterns = {"/cmpo/user/unlock/*"})
public class UnlockUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String generateRequestLogString = SingletoneLogger.generateRequestLogString(request, us.getUser(), "User unlock attempt: " , "successful", "login no: " + us.getLoginNo().toString(), "1", "user : "+ userModel.getName() + " unlocked");
