...
import cbvmp.admin.data.manager.PolicyTypesModelManager;
 ...
 */
@WebServlet(name = "ViewPolicyServlet", urlPatterns = {"/policy/view"})
...
//        PolicyTypesModelManager p = new PolicyTypesModelManager();
//        for(PolicyTypesModel pm : p.listAll()){
//            out.println(pm.getPolicyType()+" "+" "+pm.getPolicyTypeNO());
//            
//        }
//        
