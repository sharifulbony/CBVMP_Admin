 ...
 */
@WebServlet(name = "SimVerConsentUnconsentServlet", urlPatterns = {"/report/sv"})
public class SimVerConsentUnconsentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SimVerConsentUnconsentServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SimVerConsentUnconsentServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    private void generateReport(HttpServletRequest request,
        ...
        try {    
            ...
            InputStream input = classLoader.getResourceAsStream("cbvmp/jasper/jrxml/SimVer.jrxml");
            reportPath = "SimVer.jrxml";
            ...
            String reportName = "Sim_Verification_Consent_Unconsent";
            request.getSession().setAttribute("name", reportName);
            SimVerConsentUnconsentModelManager simVerManager = new SimVerConsentUnconsentModelManager();

            List<SimVerConsentUnconsentModel> list = null;
            
            
            list = simVerManager.viewReport(cmpoParam, dateFrom, dateTo, groupByTimeParam);
            ...
            if (jp.getPages().size() > 0) {
                ...
                response.sendRedirect(request.getContextPath() + "/report/sv");
            } else {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
     ...
     //  request.getRequestDispatcher("/view/report/simVerSearch.jsp").forward(request, response);
