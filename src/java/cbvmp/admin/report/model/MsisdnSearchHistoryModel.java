...
@NamedNativeQueries({
    @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_ct",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_citycell(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    ),
        @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_gp",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_gp(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    ),
        @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_bl",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_bl(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    ),
        @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_rb",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_rb(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    ),
        @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_ar",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_ar(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    ),
        @NamedNativeQuery(
           // name = "sp_msisdn_search_history_citycell",
            name = "sp_msisdn_search_history_tk",
           // query = "CALL msisdn_search(?,:p1,:p2)",
            query = "CALL msisdn_search_history_tk(?,:p1,:p2)",
            callable = true,
            resultClass = MsisdnSearchHistoryModel.class
    )
}
)
public class MsisdnSearchHistoryModel {
...
//--create_time date;
// imsi varchar2(50);
// cmpo_trn_id varchar2(50); 
// is_corporate varchar2(50); 
// purpose_no varchar2(100);
// is_registered varchar2(50);
    @Id
